###
# Plot the average hno3 anomaly as lag from QBO onset
###
...
im = plt.contourf(np.arange(-10, 22), anomalies.nLevels, wavr_oz.transpose(), np.arange(-0.7, 0.75, 0.05),
...
plt.title("MLS HNO$\mathregular{_3}$")
cb = fig.colorbar(im, orientation='horizontal', fraction=0.2, aspect=50)
cb.set_label("HNO$\mathregular{_3}$ VMR Anomaly [ppbv]")
plt.gca().invert_yaxis()
plt.tight_layout(rect=[0, -0.1, 1, 1])
plt.savefig("/home/kimberlee/Masters/NO2/Figures/QBO_average_HNO3.png", format='png', dpi=150)
plt.show()
